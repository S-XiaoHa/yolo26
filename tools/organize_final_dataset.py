...
ORIGINAL_CLASSES = [
    ...
    "up_black", "up_red", "up_yellow", "up_green",
    "down_black", "down_red", "down_yellow", "down_green",
    "left_black", "left_red", "left_yellow", "left_green",
    "right_black", "right_red", "right_yellow", "right_green",
    "turn_around_black", "turn_around_red", "turn_around_yellow", "turn_around_green",
    "prohibit_black", "prohibit_red", "prohibit_yellow", "prohibit_green",
...
def process_image_and_label(img_path, label_path, out_img_path, out_label_path):
    ...
    if need_resize:
        ...
        new_unpad = (int(round(orig_w * ratio)), int(round(orig_h * ratio)))
    ...
    if need_resize:
        ...
        img_final = cv2.copyMakeBorder(img_resized, pad_top, pad_bottom, pad_left, pad_right, cv2.BORDER_CONSTANT, value=(0, 0, 0))
